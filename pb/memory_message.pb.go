...
const (
	Memory_UNKNOWN  Memory_Unit = 0 // 未知类型
	Memory_BIT      Memory_Unit = 1 // bit
	Memory_BYTE     Memory_Unit = 2 // b
	Memory_KILOBYTE Memory_Unit = 3 // kb
	Memory_MEGABYTE Memory_Unit = 4 // MB
	Memory_GIGABYTE Memory_Unit = 5 // GB
	Memory_TERABYTE Memory_Unit = 6 // TB
)
...
type Memory struct {
	...
	// 内存由单位和值构成
	Value uint64      `protobuf:"varint,1,opt,name=value,proto3" json:"value,omitempty"`                                 // 值
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=lightsaid.pcbook.Memory_Unit" json:"unit,omitempty"` // 单位
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x64, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x22, 0xb1, 0x01, 0x0a, 0x06, 0x4d, 0x65, 0x6d,
	...
	0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x6c, 0x69, 0x67, 0x68, 0x74, 0x73,
	0x61, 0x69, 0x64, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: lightsaid.pcbook.Memory.Unit
	(*Memory)(nil),   // 1: lightsaid.pcbook.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: lightsaid.pcbook.Memory.unit:type_name -> lightsaid.pcbook.Memory.Unit
