...
var file_processor_message_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x10, 0x6c, 0x69, 0x67, 0x68, 0x74,
	0x73, 0x61, 0x69, 0x64, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x1a, 0x14, 0x6d, 0x65, 0x6d,
	...
	0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x6c, 0x69, 0x67, 0x68, 0x74, 0x73, 0x61, 0x69, 0x64, 0x2e,
...
var file_processor_message_proto_goTypes = []interface{}{
	(*CPU)(nil),    // 0: lightsaid.pcbook.CPU
	(*GPU)(nil),    // 1: lightsaid.pcbook.GPU
	(*Memory)(nil), // 2: lightsaid.pcbook.Memory
}
var file_processor_message_proto_depIdxs = []int32{
	2, // 0: lightsaid.pcbook.GPU.memory:type_name -> lightsaid.pcbook.Memory
